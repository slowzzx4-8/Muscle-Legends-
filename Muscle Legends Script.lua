...
local function confirmDanger(title, desc, onConfirm)
    local done = false
    ...
    Callback = function(v)
        ...
        pcall(function()
            Window:Dialog({
                ...
                Desc = "Needs 7 Or 8 Pet Packs. Continue?",
                Buttons = {
                    {
                        Text = "Cancel",
                        Callback = function()
                            task.defer(function()
                                if fastRebirthToggleRef and fastRebirthToggleRef.SetValue then
                                    pcall(function() fastRebirthToggleRef:SetValue(false) end)
                                end
                            end)
                        end,
                    },
                ...
                Buttons = {
                    {
                        ...
                        Callback = function()
                            task.defer(function()
                                if fastStrengthToggleRef and fastStrengthToggleRef.SetValue then
                                    pcall(function() fastStrengthToggleRef:SetValue(false) end)
                                end
                            end)
                        end,
                    },
...
autoRebirthToggleRef = Tabs.Rebirths:Toggle({
    Title = "Auto Rebirth",
    Default = cfgToggle("smartAutoRebirth", false),
    Callback = function(v)
        if not v then
        ...
        pcall(function()
            Window:Dialog({
                ...
                Desc = "Will Rebirth Until Objective. Continue?",
                Buttons = {
                    {
                        Text = "Cancel",
                        Callback = function()
                            task.defer(function()
                                if autoRebirthToggleRef and autoRebirthToggleRef.SetValue then
                                    pcall(function() autoRebirthToggleRef:SetValue(false) end)
                                end
                            end)
                        end,
                    },
    ...
    Callback = function(v)
        ...
        pcall(function()
            Window:Dialog({
                ...
                Desc = "Will Rebirth Continuously. Continue?",
                Buttons = {
                    {
                        Text = "Cancel",
                        Callback = function()
                            task.defer(function()
                                if infiniteRebirthToggleRef and infiniteRebirthToggleRef.SetValue then
                                    pcall(function() infiniteRebirthToggleRef:SetValue(false) end)
                                end
                            end)
                        end,
                    },
