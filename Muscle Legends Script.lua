...
Tabs.Brawl:Dropdown({
    ...
    Value = GetSave("BrawlAttackMode", "Punch"),
    Callback = function(v)
...
-- ========== PETS TAB ==========
Tabs.Pets:TabSection({ Title = "Buy Pet" })
local PetDropdown
Tabs.Pets:Dropdown({
    Title = "Crystal",
...
Tabs.Pets:TabSection({ Title = "Buy Aura" })
Tabs.Pets:Dropdown({
    Title = "Aura",
    Option = AuraList,
    Value = "Muscle King",
...
Tabs.Pets:TabSection({ Title = "Sell Pets" })
...
Tabs.Pets:TabSection({ Title = "Sell Auras" })
Tabs.Pets:Dropdown({
