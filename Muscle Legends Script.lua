--[[
    ...
    By Slowzzx4 (Completo + Correções: Fix Syntax, Spawn Protection, Brawl, Auto Rock)
]]
    ...
    for _, entry in ipairs(units) do
        ...
        if v >= div then
            ...
            elseif num >= 10 then
                ...
                text = text:gsub("(%..-)0+$", "%1"):gsub("%.$", "") -- Sintaxe corrigida aqui
            end
...
print("[Muscle Legends Script] By Slowzzx4 - Syntax Fixed Edition Loaded")