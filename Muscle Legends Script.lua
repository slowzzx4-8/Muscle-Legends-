...
PetDropdown = Tabs.Pets:Dropdown({
    Title = "Pet",
    Option = PetCrystalData[PetCrystalNames[1]] or PetCrystalData["Blue Crystal"],
    Value = (PetCrystalData[PetCrystalNames[1]] or PetCrystalData["Blue Crystal"])[1],
